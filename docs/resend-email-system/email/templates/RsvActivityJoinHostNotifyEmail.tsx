...
export function RsvActivityJoinHostNotifyEmail({
  hostName, userName, userEmail, activityTitle, startdate, enddate, activityLink
}: HostEmailProps) {
  ...
  return (
    <Html>
      <Section style={{ padding: '24px', fontFamily: 'sans-serif', backgroundColor: '#fff7ed', color: '#78350f' }}>
        <Heading style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '12px', color: '#fb923c' }}>
        ...
        <Section style={{ backgroundColor: '#fff', padding: '12px 20px', borderRadius: '7px', border: '1px solid #fed7aa', marginBottom: '20px' }}>
          <Text><b>프로그램</b>: {activityTitle}</Text>
          <Text><b>참가자</b>: {userName} ({userEmail})</Text>
