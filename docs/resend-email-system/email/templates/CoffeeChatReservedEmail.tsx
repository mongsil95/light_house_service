...
interface CoffeeChatReservedEmailProps {
  data: {
    name: string;
    organization: string;
    phone: string;
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.footer}>
            ...
            <Text style={styles.contact}>
              ...
              <br />
              웹사이트:{" "}
              <Link href="https://team.caresea.kr" style={styles.link}>
...
export default CoffeeChatReservedEmail;
