  ...
  return (
    <Html>
      ...
      >
        ...
        >
          안녕하세요, <strong>{data.managerName}</strong> 담당자님.
          <br />
          <br />
          이번 반려해변 정식 입양 공모에 관심을 가져주시고 신청해주셔서 진심으로 감사드립니다.
          <br />
        ...
        >
          이에 따라, <strong>반려해변 운영을 위한 기금 참여 의향</strong>을 간단히 확인드리고자
          합니다.
          <br />
          <br />
          🌿 본 기부는 <strong>자율적으로 참여</strong>하실 수 있으며, 기관당 약{" "}
          <strong>300만 원 내외</strong>의 가변 비용이 발생할 수 있습니다.
          <br />
          이는 해변 현장 운영, 참여 키트 제작, 홍보물 제작 등에 활용될 예정입니다.
          <br />
          <br />
          <strong>기부 참여 여부는 입양 심사 시 가점 요소</strong>로 반영될 수 있으며,
          <br />
        ...
        >
          아래 링크를 통해 <strong>기부 참여 의향서를 작성</strong>해주시기 바랍니다.
          <br />
