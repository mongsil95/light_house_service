  ...
  return (
    <Html>
      <Section style={{ padding: '24px', fontFamily: 'sans-serif', backgroundColor: '#ffffff' }}>
        ...
        <Text style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '8px' }}>📋 신청 요약</Text>
        ...
        {data.beaches && data.beaches.length > 0 && (
          <>
            ...
            <Text style={{ fontSize: '14px', lineHeight: '1.6', whiteSpace: 'pre-wrap', marginBottom: '16px' }}>
        ...
        <Text style={{ fontSize: '14px', lineHeight: '1.6', marginTop: '24px' }}>
          ...
          아래와 같이 심사 및 승인 일정이 진행됩니다. <br /><br />
          • <strong>심사 기간</strong>: 2025년 6월 12일(수) ~ 6월 13일(목)<br />
          • <strong>입양 승인 발표</strong>: 2025년 6월 16일(월) 15:00<br />
          &nbsp;&nbsp;&nbsp;&nbsp;→ 반려해변 플랫폼 공지사항을 통해 확인하실 수 있습니다. <br /><br />
        ...
        <Section style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
          <a href="https://team.caresea.kr" style={{ display: 'inline-block', padding: '12px 24px', backgroundColor: '#1A73E8', color: '#ffffff', textDecoration: 'none', borderRadius: '4px' }}>
            반려해변 플랫폼 방문하기
          </a>
        </Section>


        <Section style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginTop: '40px' }}>
          <Img src="https://team.caresea.kr/_next/image?url=%2Flogo%2Fgov_logo.png&w=3840&q=75" alt="해양수산부" width="80" />
          <Img src="https://team.caresea.kr/_next/image?url=%2Flogo%2Fkoem_logo.png&w=3840&q=75" alt="해양환경공단" width="80" />
          <Img src="https://team.caresea.kr/_next/image?url=%2Flogo%2Fitaseoul_logo.png&w=3840&q=75" alt="이타서울" width="80" />
        </Section>
      </Section>
    </Html>
  );
