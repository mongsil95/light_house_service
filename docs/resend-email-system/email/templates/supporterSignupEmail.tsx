  ...
  return (
    <Html>
      ...
      >
        ...
        >
          <strong>{data.username}</strong>님, 반려해변 공식 서포터즈 등록을 진심으로 환영합니다!
          <br />
          해당 계정은 <strong>이타시티(ita.city)</strong> 플랫폼과{" "}
          <strong>반려해변 서포터즈 활동 페이지</strong> 모두에서 사용됩니다.
        </Text>
        ...
        <Text style={{ fontSize: "14px", marginBottom: "3px" }}>아이디: {data.accountId}</Text>
        <Text style={{ fontSize: "14px", marginBottom: "3px" }}>닉네임: {data.username}</Text>
        <Text style={{ fontSize: "14px", marginBottom: "3px" }}>비밀번호: {data.password}</Text>
        <Text style={{ fontSize: "14px", marginBottom: "3px" }}>이메일: {data.useremail}</Text>
        ...
        <Text style={{ fontSize: "14px", lineHeight: "1.6", color: "#2c2c2c" }}>
          반려해변 서포터즈 활동 페이지는 <strong>5월 28일 전후</strong> 오픈될 예정입니다.
          <br />
          자세한 활동 가이드는 추후 이메일과 채널을 통해 안내드리겠습니다.
        </Text>

        <Text
          style={{ fontSize: "14px", fontWeight: "bold", marginBottom: "24px", color: "#2c2c2c" }}
        >
          이타서울 | 반려해변 운영팀 드림
        </Text>
        ...
        >
          ※ 본 이메일은 반려해변 서포터즈 가입 확인을 위해 발송되었습니다. <br />※ 문의:
