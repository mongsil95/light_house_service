    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6">
          {/* 1단계 - 반려해변 알아보기 */}
          <section id="step1" className="mb-20 scroll-mt-32 pt-12">
            <div className="mb-8">
          ...
          <section className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              반려해변 입양에 대해 더 자세히 알고 싶으시다면 등대지기에게 문의해보세요
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/contact">
                <button
                  className="px-8 py-3 bg-white border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold hidden
                "
                >
                  등대지기에게 연락하기
                </button>
