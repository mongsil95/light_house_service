            ...
            <div className="md:col-span-7">
                  ...
                  <div className="mb-6 px-4 md:px-0">
                    ...
                    <div className="space-y-3 pb-4">
                      {topRecommendationList.map((qa) => (
                        <Link key={qa.id} href={`/?id=${qa.id}`} className="block">
              ...
              <div className="bg-white px-4 md:px-0">
                {selectedQa ? (
                  ...
                  <div className="bg-gradient-to-br from-blue-50/30 via-white to-cyan-50/30 border border-gray-200 rounded-lg p-8 md:p-12">
                    <div className="text-center mb-10">
                      <div className="relative w-48 h-48 mx-auto mb-8">
                        {/* 배경 애니메이션 원 */}
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div
                            className="absolute w-40 h-40 bg-blue-200/30 rounded-full animate-ping"
                            style={{ animationDuration: "2s" }}
                          ></div>
                          <div
                            className="absolute w-32 h-32 bg-blue-300/40 rounded-full animate-pulse"
                            style={{ animationDuration: "1.5s" }}
                          ></div>
                        </div>
                        {/* 로고 이미지 */}
                        <div
                          className="relative z-10 flex items-center justify-center h-full animate-bounce"
                      ...
                      >
                        {selectedCategory === "전체"
                          ? "아직 등록된 글이 없어요"
                          : `'${selectedCategory}'에 대한 정보를 준비 중이에요`}
                      </h3>
                      <p
                        className="text-base md:text-lg text-gray-600 mb-2"
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        등대지기가 열심히 좋은 글을 준비하고 있으니,
                      </p>
                      <p
                    ...
                    <div className="max-w-2xl mx-auto">
                      <p
                        className="text-lg font-bold text-black mb-4 text-left"
                        style={{ fontFamily: "Cafe24_Ssurround, sans-serif" }}
                      >
                        이런 글은 어때요?
                      </p>
                      <div className="space-y-3">
                        {qaList
                          ...
                          .map((qa) => (
                            <Link key={qa.id} href={`/?id=${qa.id}`} className="block">
                              <div className="hover:bg-gray-50 transition-all cursor-pointer group py-4 border border-gray-200 rounded-lg px-4">
